================================================================================
README-INDEX: CodeBrix.Platform.Fonts.Fluent
...
------------------------------------------------------------------
  AGENT-README.txt
      CodeBrix.Platform.Fonts.Fluent.ApacheLicenseForever — the Fluent
      icon (symbols) font for CodeBrix.Platform applications: the font URI,
      the glyph coverage and Symbol-enum mapping, the MSBuild property it
      sets, and the opt-out.
